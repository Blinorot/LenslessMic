...
from lensless.utils.image import gamma_correction, resize, rgb2gray
from lensless.utils.io import load_image, load_psf, save_image
from lensless.utils.plot import (
    pixel_histogram,
    plot_autocorr2d,
    plot_cross_section,
    plot_image,
...
def analyze_image(
    ...
    if lens:
        fig_gray, ax_gray = plt.subplots(
            ncols=3, nrows=1, num="Grayscale", figsize=(15, 5)
        )
    else:
        fig_gray, ax_gray = plt.subplots(
            ncols=2, nrows=1, num="Grayscale", figsize=(15, 5)
        )
    ...
    if lens:
        ...
        fig_auto, ax_cross = plt.subplots(
            ncols=3, nrows=1, num="RGB widths", figsize=(15, 5)
        )
